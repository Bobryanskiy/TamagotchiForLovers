...
class RoomLocalPetDataSource @Inject constructor(
    ...
    override suspend fun updateLifeState(petId: String, status: String, deathCause: String?, timestamp: Long) =
        petDao.updateLifeState(petId, status, deathCause, timestamp)

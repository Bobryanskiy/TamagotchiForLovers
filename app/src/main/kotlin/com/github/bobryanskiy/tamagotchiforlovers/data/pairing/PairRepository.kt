...
class PairRepository(private val pairStorage: PairStorage, private val petStorage: PetStorage, private val dataSource: PairViaFirebase) {
    ...
    suspend fun createNewPair(): Result<PairModel> {
        ...
        if (result is Result.Success) {
            ...
            petStorage.savePetState(result.data.petState)
        }
        return result
    }

...
class AppSessionStorage @Inject constructor(
    ...
    private companion object {
        ...
        val KEY_IS_PET_LOCAL = stringPreferencesKey("is_pet_local")
    }
    ...
    val isPetLocal: Flow<String?> = dataStore.data.map { it[KEY_IS_PET_LOCAL] }
    ...
    suspend fun setIsPetLocal(flag: Boolean) {
        dataStore.edit { it[KEY_IS_PET_LOCAL] = flag.toString() }
    }
